            ...
            >
              ...
              >
                <div>
                  ...
                  <span class="stat-lbl" style="color: var(--gray-dark); letter-spacing: 0.12em; font-size: 10px; text-transform: uppercase">Years in business</span>
                </div>
                <div>
                  <span class="stat-num serif" style="color: var(--gold); font-size: 44px; display: block">500+</span>
                  <span class="stat-lbl" style="color: var(--gray-dark); letter-spacing: 0.12em; font-size: 10px; text-transform: uppercase">Properties sold & let</span>
                </div>
                <div>
                  <span class="stat-num serif" style="color: var(--gold); font-size: 44px; display: block">8</span>
                  <span class="stat-lbl" style="color: var(--gray-dark); letter-spacing: 0.12em; font-size: 10px; text-transform: uppercase">Areas covered</span>
                </div>
                <div>
                  <span class="stat-num serif" style="color: var(--gold); font-size: 44px; display: block">98%</span>
                  <span class="stat-lbl" style="color: var(--gray-dark); letter-spacing: 0.12em; font-size: 10px; text-transform: uppercase">Client satisfaction</span>
                </div>
              </div>
            </div>
          </div>
